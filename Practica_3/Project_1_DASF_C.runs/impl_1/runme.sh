...
HD_PWD='C:/Users/PRACTICAS/Project_1_DASF_C/Project_1_DASF_C.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log top_practica1.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source top_practica1.tcl -notrace
